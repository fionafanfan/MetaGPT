...
class MyQaEngineer(Role):
    ...
    def get_workspace(self, return_proj_dir=True) -> Path:
        ...
        # project directory: workspace_bak2/{package_name}, which contains package source code folder, tests folder, resources folder, etc.
        if return_proj_dir:
            return WORKSPACE_ROOT / workspace
        # development codes directory: workspace_bak2/{package_name}/{package_name}
    ...
    async def _run_code(self, msg):
        ...
        result_msg = await RunCode().run(
            ...
            working_directory=proj_dir,  # workspace_bak2/package_name, will run tests/test_xxx.py here
            additional_python_paths=[development_code_dir],  # workspace_bak2/package_name/package_name,
